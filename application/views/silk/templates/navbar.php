    <div class="main-header">
      ...
      <div id="logo" class="logo-header" data-background-color="white">
        <a href="<?= base_url('silk/dashboard') ?>" class="logo">
      ...
      <nav id="navbar" class="navbar navbar-header navbar-expand-lg" data-background-color="white">
        <div class="container-fluid">
          <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
            ...
            <li class="nav-item">
              <a class="nav-link btn" href="<?= base_url('silk/auth/logout') ?>" onclick="return confirm('apakah anda yakin ingin keluar?')" data-toggle="tooltip" data-original-title="Keluar">
