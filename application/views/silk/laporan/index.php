              ...
              <div class="card">
                <div class="card-header">
                  <div class="card-head-row">
                    ...
                    <div class="card-tools">
                      <a id="export-link" href="<?= base_url('silk/laporan/pdf/') . $last_year ?>" class="btn btn-info btn-border btn-round btn-sm">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <select name="tahun" class="form-control" onchange="getsilk/(this.value), addTahun(this.value)">
                ...
                <div class="card-body">
                  <div class="row" id="fromHTMLtestdiv">
                    <div id="silk/" class="col-sm-12 table-responsive">
                    </div>
                  </div>
                </div>
              </div>
